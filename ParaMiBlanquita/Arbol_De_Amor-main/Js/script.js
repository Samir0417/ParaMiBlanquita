...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para alguien muy especial:\n\nAunque llevamos poco tiempo, estos días contigo han sido increíbles. Me encanta conocerte, descubrir tu forma de pensar, tu risa y esos pequeños detalles que te hacen única.\n\nGracias por compartir tu tiempo conmigo y por hacer que cada conversación sea especial. Me ilusiona mucho lo que estamos construyendo, paso a paso y sin prisas.\n\nEstoy feliz de que coincidamos en este momento.\n\nCon cariño 💗`;
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Samir ";
...
function startFloatingObjects() {
  ...
  let count = 0;
  function spawn() {
    let el = document.createElement('0div');
